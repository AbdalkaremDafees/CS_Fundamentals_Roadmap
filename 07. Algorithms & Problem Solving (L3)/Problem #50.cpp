/*
       Problem #50: Write a program to find a client by
          account number and delete them from file.
*/
#include <iostream>
#include <vector>
#include <string>
...
void DeleteAccount(vector<ClientsData> vClients, string target) {
    ClientsData stClient;
    char choice = 'Y';
