/*
        Project 2: Extension for Project 1 'Bank Management System in C++',
                        Transaction: Deposit - Withdraw - Total
*/
#include <iostream>
#include <string>
#include <vector>
...
enum enMenu { Show = 1, Add = 2, Delete = 3, Update = 4, Find = 5, Transaction = 6, Exit = 7 };
enum enTransMenu { Deposit = 1, Withdraw = 2, TotalBalance = 3, MainMenu = 4 };
...
void TransactionProgram() {
    ...
    do {
        ...
        switch (choice) {
        case enTransMenu::Deposit:
            system("cls");
            DepositScreen();
            BackToTransMenu();
            break;
        case enTransMenu::Withdraw:
            system("cls");
            WithdrawScreen();
            BackToTransMenu();
            break;
        case enTransMenu::TotalBalance:
            system("cls");
            PerformTotalBalance();
            BackToTransMenu();
            break;
        case enTransMenu::MainMenu:
